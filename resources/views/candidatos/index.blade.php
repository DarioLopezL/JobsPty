                ...
                <div class="p-6 bg-white border-b border-gray-200">
                  ...
                  <div class="md:flex md:justify-center p-5">
                        <ul class="divide-y divide-gray-200 w-full">
                            @forelse ($vacante->candidatos as $candidato)
                                <li class="p-3 flex items-center ">
                                    <div class="flex-1">
                                       ...
                                       <p class="text-xl  text-gray-600">Día que se postuló: <span class="font-normal">{{ $candidato->user->created_at->diffForHumans() }}</span></p>
                                    </div>
                                    <div>
                                        ...
                                        href="{{ asset('storage/cv/' . $candidato->cv) }}" target="__blank"
                            ...
                            @empty
                            <p class="p-3 text-center text-sm text-gray-800">No hay candidatos aún</p>
                            @endforelse
                        </ul>
                    </div>
                </div>
